...
async function main() {
  console.log("Deploying ContractStorage contract...");
  ...
  const address = await contractStorage.getAddress();
  console.log("\n✅ ContractStorage deployed to:", address);
  ...
  const deploymentTx = contractStorage.deploymentTransaction();
  if (deploymentTx) {
